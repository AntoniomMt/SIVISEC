...
# DeepSort con parámetros ajustados
tracker = DeepSort(
    max_age=60,     # mantiene ID aunque se pierda por varios frames
    n_init=3,       # más estable al confirmar tracks
    nn_budget=100   # buen balance entre precisión y velocidad
)

# Filtros de detección ajustados para reducir falsos positivos
conf_threshold = 0.45
min_area = 12000
aspect_ratio_threshold = 0.45
...
while cap.isOpened():
    ...
    # Redimensionar para entrada YOLO
    ...
    # Filtrar cajas que contienen otras
    filtered_detections = []
    ...
    # Filtrar cajas que se solapan demasiado
    final_detections = []
    ...
    for track in tracks:
        ...
        # Dibujo de la caja (NO más grueso de lo necesario)
