...
out = cv2.VideoWriter('output_ultra_v8.mp4', fourcc, fps, (video_width, video_height))
...
while cap.isOpened():
    ...
    if frame_count % yolo_interval == 0:
        ...
        # Filtro de cajas que engloban a otras
        filtered = []
        for i, (boxA, scoreA, labelA) in enumerate(candidates):
            contains = False
            for j, (boxB, _, _) in enumerate(candidates):
                if i == j:
                    continue
                xa1, ya1, xa2, ya2 = boxA
                xb1, yb1, xb2, yb2 = boxB
        ...
        # Filtro de solapamientos sospechosos
        final = []
