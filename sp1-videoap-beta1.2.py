...
# Ajustes de sensibilidad y rendimiento
conf_threshold = 0.2
min_area = 3000
...
while cap.isOpened():
    ...
    # Procesamos en tamaño reducido (1280x720)
    ...
    # 🧠 Filtro: eliminar cajas grandes que contengan completamente otras
    filtered_detections = []
    ...
    # Tracking con detecciones limpias
