...
while cap.isOpened():
    ...
    # Redimensionar internamente a Full HD para detección
    frame_small = cv2.resize(frame, (1920, 1080))
    results = model(frame_small, verbose=False, conf=conf_threshold)

    scale_x = video_width / 1920
    scale_y = video_height / 1080
    ...
    # Filtrar cajas que engloban completamente a otras
    filtered_detections = []
