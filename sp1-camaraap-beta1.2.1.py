...
fps = 15  # FPS real y constante para evitar aceleración
...
while True:
    ...
    if detections:
        ...
        for i, track in enumerate(tracks, start=1):
            ...
            font_thickness = max(2, int(0.0018 * video_width))  # MÁS GRUESO
            ...
            cv2.rectangle(frame, (x1, y1), (x2, y2), (180, 220, 255), thickness)
