...
for filename in os.listdir(input_folder):
    ...
    # Ajustar tamaño para YOLO y escalar luego
    ...
    for idx, (box, score, label) in enumerate(final_detections, start=1):
        ...
        thickness = max(6, int(0.005 * video_width))  # línea
        font_scale = max(0.4, 0.0007 * video_width)    # tamaño fuente
        ...
        cv2.putText(frame, label_text, label_origin, cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 0), font_thickness)
